...
## 11.5 Banner 配置表 `banner_config.xlsx`

P2 pubble 页签 banner 主动进度条与离线补偿（与 feed_instances 放置分离）。

| 字段 | 说明 |
|------|------|
| tabtype | 0=广场 / 903=嫂子站 / 904=我的站子 |
| activedurationsec | 在线满格秒数（如 30） |
| activegranttype | 满格奖励货币：22=fp / 24=intel / 23=stars |
| activegrantamt | 满格奖励数量 |
| offlinedurationsec | 离线多少秒折算 1 次满格奖励 |
| offlinemaxsec | 单次登录离线结算上限秒 |
