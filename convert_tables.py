...
TABLES = [
    ...
    },
    {
        ...
        "out": "hot_rates.json",
        "skip_meta_rows": 2,
        "int_cols": ["heatmin", "heatmax", "bonusrate"],
        "float_cols": [],
    },
    {
        "base": "idle_rewards",
        "src": "放置收益表",
        "out": "idle_rewards.json",
        "skip_meta_rows": 2,
        "int_cols": ["id", "intervalmin", "intervalmax", "fpcap", "fanscap"],
        "float_cols": [],
    },
    {
        "base": "level_clear_posts",
        "src": "通关发帖表",
        "out": "level_clear_posts.json",
        "skip_meta_rows": 2,
        "int_cols": [],
        "float_cols": [],
    },
